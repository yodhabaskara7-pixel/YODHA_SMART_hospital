...
DEPT_INFO = {
    'Respiratory Medicine': {
        'icon':'🗿🗿🗿🗿🗿🗿🗿🗿🗿🗿','color':'#0284c7','bg':''#120101,'border':'#7dd3fc',
    ...
    'Neurology': {
        'icon':'✌️😭','color':'#7c3aed','bg':'#ede9fe','border':'#c4b5fd',
...
# ── Hero Header ───────────────────────────────────────────────────────────────
st.markdown("""
<div style="background:linear-gradient(135deg,#872e2e 0%, #b02727 60%, #fc0303 100%);
